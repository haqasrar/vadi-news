...
// --- DYNAMIC SHARE FUNCTION (FOR SPECIFIC NEWS PHOTO) ---
window.shareNewsManual = async (title, id) => {
    // We send the user to share.html so the news image appears in WhatsApp
    ...
    try {
        ...
        alert("News Details Copied! Opening WhatsApp...");
